...
//!     cargo test -p dns-orchestrator-provider --test aliyun_test -- --ignored --nocapture
//! ```
...
crud_test!(test_aliyun_crud_a_record, TestRecordType::A, "A");
crud_test!(test_aliyun_crud_aaaa_record, TestRecordType::Aaaa, "AAAA");
crud_test!(
    test_aliyun_crud_cname_record,
    TestRecordType::Cname,
    "CNAME"
);
crud_test!(test_aliyun_crud_mx_record, TestRecordType::Mx, "MX");
crud_test!(test_aliyun_crud_txt_record, TestRecordType::Txt, "TXT");
crud_test!(test_aliyun_crud_srv_record, TestRecordType::Srv, "SRV");
crud_test!(test_aliyun_crud_caa_record, TestRecordType::Caa, "CAA");
